class Plan_StagingStress : Plan
{
    ...
    Init()
    {
        ...
        $this.Tasks.Add([Plan_New_StageFiles]::new($this.Hostnames[0..5], $_SessionName, $this.SourcePath, $this.CopyToPath, $this.ExtractToPath, $this.Async))
        $this.Tasks.Add([Plan_New_StageFiles]::new($this.Hostnames[6..11], $_SessionName, $this.SourcePath, $this.CopyToPath, $this.ExtractToPath, $this.Async))
